...
def run(
    ...
    manifest = {
        ...
        "annual_reports": {
            ...
            "human_notes": "blank by default; when served locally, persisted as append-only JSONL outside generated artifacts",
            "human_notes_server": "observatory-serve; loopback only; static HTML remains readable without it",
